...
--EXEC [ERP_REPORTS].[usp_ERP_GetAdvanceFromStudentWithInvoiceNo] null,107,'2025-03-01','2025-04-03','ALL'    
    
CREATE PROCEDURE [ERP_REPORTS].[usp_ERP_GetAdvanceFromStudentWithInvoiceNo]            
(            
...
FROM     dbo.T_Invoice_Parent AS P            
 ...
 --T.I_Student_Detail_ID,            
    ...
    T.I_Roll_No as Roll_No,            
    T.S_Student_Name as StudentName,            
    T.S_Invoice_No as InvoiceNo,            
    T.S_Receipt_No as ReceiptNo ,            
    T.Dt_Invoice_Date as Invoice_Date,            
    T.S_Component_Name as ComponentName,            
    --T.S_Batch_Name,            
    --T.S_Course_Name,            
    --T.I_Center_ID,            
    T.S_Center_Name as Center_Name,            
    T.S_Brand_Name as Brand,            
    T.S_Cost_Center as Cost_Center,            
    T.Due_Value,            
 ...
 ,--T5.InvoiceNo as AdvanceInvoiceNo,            
    ...
    (            
     ...
     inner join T_Receipt_Header TRH on TRCD.I_Receipt_Detail_ID=TRH.I_Receipt_Header_ID           where            
