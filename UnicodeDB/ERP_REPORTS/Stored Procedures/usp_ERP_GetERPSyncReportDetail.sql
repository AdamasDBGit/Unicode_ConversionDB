CREATE PROCEDURE [ERP_REPORTS].[usp_ERP_GetERPSyncReportDetail]    
    (    
...
AS     
    ...
    INNER JOIN dbo.T_Centre_Master AS tcm ON tstd.S_Cost_Center = tcm.S_Cost_Center    
        ...
        WHERE   tstd.I_Enquiry_Regn_ID IS NULL    
                ...
                AND tcm.I_Centre_Id IN (SELECT fgcfr.centerID FROM dbo.fnGetCentreIdByBrandId(@iBrandID) AS fgcfr)    
