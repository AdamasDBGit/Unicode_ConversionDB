CREATE PROCEDURE [ERP_REPORTS].usp_ERP_GetProvisionalPromotedList    
    (    
...
AS     
  ...
  BEGIN    
        ...
        FROM    dbo.T_Student_Detail TSD    
                ...
                --LEFT  JOIN dbo.T_Center_Hierarchy_Name_Details TCHND ON TCBD.I_Centre_Id = TCHND.I_Center_ID    
    ...
    Inner Join T_Centre_Master CMM ON CMM.I_Centre_Id=TCBD.I_Centre_Id  
