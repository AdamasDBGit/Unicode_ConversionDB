...
CREATE    PROCEDURE [ERP_REPORTS].[usp_ERP_GetDueReport_History_API]               
--EXEC [ERP_REPORTS].[usp_ERP_GetDueReport_HistoryNEW] 'null', 107, '2025-05-30', 'ALL'              
   ...
   @sessionID int=NULL,  
      @iBrandID INT=NULL ,  
   @StrSchool_Group varchar(100)=NULL,  
   @strclass varchar(50)=NULL,  
   @instreamID varchar(20)=NULL,  
   @insectionID varchar(100)=NULL,  
    @fromdt Date=NULL,      
    @dtUptoDate DATETIME=NULL ,              
    @sStatus VARCHAR(100) = 'ALL', 
    @strstream varchar(50)=NULL,
    @strsection varchar(50)=NULL
    )              
AS               
    BEGIN              
      --SELECT  *             
