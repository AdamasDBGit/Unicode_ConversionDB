...
--EXEC [ERP_REPORTS].[usp_ERP_GetMonthlyCollectableReport]     107,null,'2025-04-01','2025-04-30'
CREATE PROCEDURE [ERP_REPORTS].[usp_ERP_GetMonthlyCollectableReport]      
    (      
      @iBrandID INT ,      
...
AS      
    BEGIN      
      ...
      --Select dbo.fnGetCentreIdByBrandId(@iBrandID)    
        ...
        INSERT  INTO #INVDET      
                ...
                SELECT  TCHND.S_Center_Name ,      
						...
						COALESCE(rd.S_Email_ID,rd.S_Father_Email, rd.S_Mother_Email),
                        TSD.I_RollNo ,      
                ...
                FROM    dbo.T_Invoice_Parent TIP      
                        ...
                        --                    FROM    dbo.fnGetCentreIdByBrandId(@iBrandID) AS FGCFR ) --AND TIP1.I_Invoice_Header_ID=260338      
						...
						Inner Join T_Class tc on tc.I_Class_ID=sgc.I_Class_ID and tc.I_Brand_ID=@iBrandID
						Inner Join T_School_Group sg on sg.I_School_Group_ID=sgc.I_School_Group_ID
						LEFT Join T_Enquiry_Regn_Detail rd on rd.I_Enquiry_Regn_ID=TSD.I_Enquiry_Regn_ID
...
INNER JOIN dbo.T_Receipt_Component_Detail      
  ...
  I.S_Center_Name Centre,  
  I.TypeOfCentre "Type Of Centre",  
  I.S_Course_Name Class,  
  I.S_Batch_Name "School Group",  
  I.S_Student_ID "Student ID",  
  I.StudentName "Name",  
  I.ContactNo "Contact No",
  I.Email AS "Email",
  I.I_RollNo "Roll No",  
  --I.I_Invoice_Header_ID,  
  I.S_Invoice_No "Invoice No",  
  I.InvoiceCreationDate "Invoice Creation Date",  
  --I.I_Invoice_Detail_ID,  
  I.I_Installment_No "Instalment No",  
  I.Dt_Installment_Date "Collectable Date",  
  I.S_Component_Name "Collectable Fee Component",  
  I.N_Amount_Due "Initial Outstanding Amount(Excl. Tax)",  
  I.CreditNoteAmt "Credit Note Amount(Excl. Tax)",  
  I.ReceiptCompAmount "Total Paid(Excl. Tax)",  
  I.TotalDiff "Collectable Amount(Excl. Tax)"  
  
  --I.TaxDue,  
  --I.TaxPaidAdvBeforeGST,  
  --I.TaxPaidAdvAfterGST,  
  --I.TotalTax,  
