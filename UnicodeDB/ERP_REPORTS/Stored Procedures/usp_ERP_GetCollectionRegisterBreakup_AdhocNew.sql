...
--EXEC [ERP_REPORTS].[usp_ERP_GetCollectionRegisterBreakup_AdhocNew] null,107,'2025-04-01','2025-04-24','ALL'        
        
CREATE PROCEDURE [ERP_REPORTS].[usp_ERP_GetCollectionRegisterBreakup_AdhocNew] --195,61,'12/1/2007','1/1/2008','ALL'                
    (              
...
AS               
   ...
   --TSBD.I_Status as newStatus,                
                       ...
                       case when  RH.I_Status=1 then 'Active' Else 'Cancel'end  as Receipt_Status ,              
