 ...
 CREATE PROCEDURE [ERP_REPORTS].[usp_ERP_GetCollectionRegisterReport]   
    (  
 ...
 SELECT  @iCenterID=FGCFR.centerID  FROM  dbo.fnGetCentreIdByBrandId(@iBrandID) FGCFR   
     ...
     centerName  
      ...
      NULL ,  
                        ...
                        S_Center_Code,  
                        S_Center_Name  
                FROM    T_Centre_Master where I_Centre_Id=@iCenterID  
   ...
   --TSBD.I_Status as newStatus,    
          ...
          THEN CAST([RH].[S_ChequeDD_No] AS VARCHAR(20))--added by susmita : 2023-jan-28 :For Loan Payment mode  
                               ...
                               -(  CAST(ISNULL(dbo.fnCalculateConvenienceCharge(ISNULL(RH.N_Receipt_Amount,  
                                ...
                                ,CASE WHEN TID.ReceiptHeaderID IS NULL THEN 'Offline('+PMM.S_PaymentMode_Name+')'  
         ELSE 'Online('+TID.S_TransactionMode+')' END  
                        FROM    dbo.T_Receipt_Header RH  
                                ...
                                LEFT JOIN dbo.T_Currency_Master CUM WITH ( NOLOCK ) ON RH.I_Currency_ID = CUM.I_Currency_ID  
        LEFT JOIN   
        (  
