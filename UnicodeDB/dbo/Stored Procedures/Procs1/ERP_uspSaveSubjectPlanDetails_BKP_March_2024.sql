...
-- =============================================
CREATE PROCEDURE [dbo].[ERP_uspSaveSubjectPlanDetails_BKP_March_2024] 
...
BEGIN TRY
	...
	DECLARE cursor_log CURSOR
			...
			WHILE @@FETCH_STATUS = 0
				...
				and I_Month_No=@MonthNo and I_Day_No=@DayNo
				)	
				...
				BEGIN
					...
					select @SubjectID,@DayNo,@MonthNo,@CreatedBy,GETDATE()
