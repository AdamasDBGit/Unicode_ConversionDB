...
CREATE PROCEDURE [dbo].[usp_ERP_UpdateStudentDetail]     
    ...
    @PrevSchool NVARCHAR(MAX) = NULL,    
    @PrevBoard NVARCHAR(MAX) = NULL,    
    @PrevAddress NVARCHAR(MAX) = NULL,    
    @SibID NVARCHAR(MAX) = NULL,    
    @SibName NVARCHAR(MAX) = NULL,    
    @SibRunning INT = NULL,    
    @SibPassYear NVARCHAR(MAX) = NULL,    
    @UpdatedBy INT = NULL,    
