...
-- =============================================
CREATE PROCEDURE [dbo].[usp_ERP_CancleInitiatedFailedTransaction_BKP_AUG_2025] 
		...
		BEGIN
				...
				--    </Root>';
					...
					SELECT 
						...
						TRY_CAST(AdhocDetail.value('@InstallmentDate', 'nvarchar(50)') AS datetime) AS InstallmentDate
