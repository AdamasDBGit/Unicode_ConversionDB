...
CREATE PROCEDURE [dbo].[usp_ERP_insert_Update_Fee_Plan_Structure_Component_BKP_May_2025]        
...
BEGIN        
  ...
  DECLARE @ErrMessage NVARCHAR(4000)  
        ...
        BEGIN
			...
			IF not exists(select * from T_Course_Fee_Plan where S_Fee_Plan_Name = @p_S_Fee_Structure_Name)
