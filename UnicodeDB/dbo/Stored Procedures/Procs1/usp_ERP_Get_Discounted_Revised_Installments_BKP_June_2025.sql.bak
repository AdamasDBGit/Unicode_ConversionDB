...
CREATE PROCEDURE [dbo].[usp_ERP_Get_Discounted_Revised_Installments_BKP_June_2025]  
...
SELECT   
 CAST(FeeComp.Value AS INT) AS FeeComponentID,  
 CASE WHEN DSD.S_FromInstalment = 'F' THEN 1 ELSE 0 END AS IsfromStart,  
 CASE WHEN DSD.S_FromInstalment = 'L' THEN 1 ELSE 0 END AS IsfromEnd,  
