...
CREATE PROCEDURE [dbo].[ERP_uspInsertInvoice_ForTEST]             
(            
 @sInvoice XML,            
 @iBrandID INT = NULL,            
...
-- insert value for the invoice child                       
 ...
 SET @studentID=(Select I_Student_Detail_ID from #tempInvoice)
 SET @SessionID=(
