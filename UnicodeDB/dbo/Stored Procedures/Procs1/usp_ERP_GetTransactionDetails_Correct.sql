...
-- =============================================
CREATE PROCEDURE [dbo].[usp_ERP_GetTransactionDetails_Correct] 
...
insert into #Transaction_History
	...
	DECLARE @PendingPaymentCount INT=0
     ...
     select 
	  ...
	  and RCD.TotalPaidAmount >= Invoice.TotalDue
	  where TM.I_ERP_TransactionNo=@TransactionNo
...
select 
	...
	CASE WHEN @InvalidInvoicecount > 0 OR @PendingPaymentCount <= 0 THEN 'false' 
	ELSE
	'true' END ISAllowed
	from 
