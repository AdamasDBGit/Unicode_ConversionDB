...
CREATE PROCEDURE [dbo].[usp_ERP_GetInvoiceDetail_BKP]  --[dbo].[uspGetInvoiceDetail] 168173       
    (
...
(	SELECT DISTINCT I_Invoice_Header_ID, I_Installment_No,   
 ...
 left join
 (select I_Credit_Note_Invoice_Child_Detail_ID,sum(N_Tax_Value) as CreditedTotalTaxAmount
 from T_Credit_Note_Invoice_Child_Detail_Tax group by I_Credit_Note_Invoice_Child_Detail_ID) as ICCDT on ICCD.I_Credit_Note_Invoice_Child_Detail_ID=ICCDT.I_Credit_Note_Invoice_Child_Detail_ID
