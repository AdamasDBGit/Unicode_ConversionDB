...
-- =============================================
CREATE   PROCEDURE  [dbo].[usp_ERP_GetLogBookMappedDetails_BKP_DEC2023]
...
BEGIN
	...
	select DISTINCT
	Logbook.* ,
	CASE WHEN ISNULL(LogRegisterAfter.TotalRegisteredAfter,0) > 0 then 'false'
	ELSE
	'true'
	END as IsEditable,
	...
	,SSPER.Dt_ExecutedAt as ClassExecutedDate,ISNULL(SSPER.Is_Completed,'false')  as IsDayCompleted
