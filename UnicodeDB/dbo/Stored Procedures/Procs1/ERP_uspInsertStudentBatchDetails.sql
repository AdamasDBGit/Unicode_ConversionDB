...
------------------End---------------------------------------
                  ...
                  -- select @bIsFromPromoteBatch,@iBatchId,@iSourceBatchID,@iStudentDetailId  
                ...
                IF @bIsFromPromoteBatch = 1    
                    BEGIN                    
					   ...
					   --select 1
						...
						update dbo.T_Student_Batch_Details set I_Status=2,Dt_Valid_To=GETDATE(),
						I_ToBatch_ID=@iBatchId where I_Student_ID=@iStudentDetailId and I_Batch_ID=@iSourceBatchID and I_Status in (1,2)
