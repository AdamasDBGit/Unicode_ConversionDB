...
(      
 ...
 @sPrevSchoolName NVARCHAR(MAX) = null,      
 @sPrevSchoolAddress NVARCHAR(MAX) = null,      
 @sPrevBoard NVARCHAR(MAX) = null,      
 ...
 @iIsSibling bit = null,      
 @sSiblingStudentID NVARCHAR(MAX) = null,      
 @sSiblingStudentName NVARCHAR(MAX) = null,      
 @iSiblingIsRunningStudent bit = null,      
 @sSiblingPassoutYear NVARCHAR(MAX) = null,      
...
BEGIN      
 ...
 ------Checking Student Existense--------------  
 If Exists (select 1 from t_student_detail where I_Enquiry_Regn_ID=@iEnquiryRegnID)  
 Begin  
 ...
 SET       
  ...
  I_Enquiry_Status_Code = 3,      
  App_Payment_Status = 1,      
  I_Stream_ID = @iStreamID,      
  R_I_School_Session_ID = @iSchoolSessionID,      
  I_Info_Source_ID = @iInfoSourceID,      
  Dt_Upd_On = GETDATE(),      
  R_I_AdmStgTypeID = 6 -- Set the admission stage as Enquiry      
 ...
 SET @Course_ID = (Select top 1 I_Course_ID from T_Course_Group_Class_Mapping Where I_Brand_ID = @iBrandID and I_Class_ID = @iCourseAppliedFor and I_School_Session_ID = @iSchoolSessionID and (I_Stream_ID = @iStreamID OR I_Stream_ID IS NULL))      
 UPDATE [dbo].[T_Enquiry_Course]      
 SET       
