...
BEGIN  
 ...
 --SET @istudentID=(
 --select I_Student_Detail_ID from T_Student_Detail where I_Enquiry_Regn_ID=@iEnquiryRegnID
 -- )
 ...
 UPDATE T_Student_Detail  
     SET S_Email_ID =  @sEmail ,S_First_Name=@sFirstName ,S_Middle_Name=@sMiddleName,S_Last_Name=@sLastName
    WHERE I_Enquiry_Regn_ID = @iEnquiryRegnID  
