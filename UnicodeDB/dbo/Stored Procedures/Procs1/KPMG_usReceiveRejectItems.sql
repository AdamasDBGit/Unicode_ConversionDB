...
BEGIN
	...
	DECLARE @TBL_STOCK TABLE(UUID INT IDENTITY(1,1),ItemCode NVARCHAR(max),Quantity INT) 
	DECLARE @TBL_STOCK_DTL TABLE(ItemCode NVARCHAR(max),BarCode NVARCHAR(max)) 
