...
Begin      
    ...
    DROP TABLE #FirebaseTokens;
     CREATE TABLE #FirebaseTokens      
        (      
            firebase_token Nnvarchar(max) NULL,      
            student_id Nnvarchar(max) NULL,      
            student_name Nnvarchar(max) NULL,      
            parent_name Nnvarchar(max) NULL,      
            student_dob DATE NULL,      
            student_address Nnvarchar(max) NULL,      
            student_roll_no Nnvarchar(max) NULL,      
            class_teacher_name Nnvarchar(max) NULL,      
            current_grade_class Nnvarchar(max) NULL,      
            current_grade_class_section_stream Nnvarchar(max) NULL,      
            student_phone Nnvarchar(max) NULL,      
            student_email Nnvarchar(max) NULL,      
            inParentMasterID INT NULL,      
            school_id INT NULL, school_name Nnvarchar(max) NULL,      
            school_logo Nnvarchar(max) NULL, school_address Nnvarchar(max) NULL,      
            school_contact_number Nnvarchar(max) NULL, school_email Nnvarchar(max) NULL,      
            academic_year Nnvarchar(max) NULL, principal_name Nnvarchar(max) NULL,      
            event_description Nnvarchar(max) NULL, event_start_date DATETIME NULL, event_end_date DATETIME NULL,      
            event_category Nnvarchar(max) NULL, event_start_time Nnvarchar(max) NULL, event_end_time Nnvarchar(max) NULL,      
            event_location Nnvarchar(max) NULL, event_type Nnvarchar(max) NULL, rsvp_link Nnvarchar(max) NULL,      
            current_due_amount DECIMAL(18,2) NULL, current_due_date DATETIME NULL,      
            last_payment_id INT NULL, last_payment_status Nnvarchar(max) NULL,      
            ...
            current_due_payment_link Nnvarchar(max) NULL,      
            enquiry_no Nnvarchar(max) NULL, provisional_student_name Nnvarchar(max) NULL,      
            admission_date DATETIME NULL, admission_stage Nnvarchar(max) NULL,      
            previous_school_name Nnvarchar(max) NULL, previous_academic_record Nnvarchar(max) NULL,      
            submitted_documents Nnvarchar(max) NULL, provisional_student_parent_name Nnvarchar(max) NULL,      
            admission_fee DECIMAL(18,2) NULL, admission_grade_class_section_stream Nnvarchar(max) NULL,      
            gatepass_issue_date DATETIME NULL, gatepass_expiry_date DATETIME NULL,      
            gatepass_reason Nnvarchar(max) NULL, parent_master_id INT NULL, gatepass_issuer_name Nnvarchar(max) NULL,      
            user_id INT NULL, recipient_name Nnvarchar(max) NULL, birthday_year INT NULL,      
            work_experience_years Nnvarchar(max) NULL, is_Faculty BIT NULL, join_date DATETIME NULL,      
            stParentToken Nnvarchar(max) NULL      
        )
