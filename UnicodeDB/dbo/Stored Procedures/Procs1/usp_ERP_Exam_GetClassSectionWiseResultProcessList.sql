...
-- =============================================        
--EXEC [usp_ERP_Exam_GetClassWiseResultProcessList] 35,null,'6',null,null,null,null,1,'desc',1,10    
CREATE PROC [dbo].[usp_ERP_Exam_GetClassSectionWiseResultProcessList]         
(           
    @SessionId INT = NULL,        
...
BEGIN         
    ...
    WITH PAGED AS (        
		  ...
		  WHERE SD.inResultProcessStatus IN (2,3)'        
