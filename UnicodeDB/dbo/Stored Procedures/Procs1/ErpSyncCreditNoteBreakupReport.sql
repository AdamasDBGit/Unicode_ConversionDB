...
BEGIN
	...
	SELECT	tbcd.I_Brand_ID, tttm.I_Transaction_Type_ID, tip.I_Student_Detail_ID,tsd.S_Student_ID,
			tcm.S_Cost_Center, ABS(ISNULL(ticd.N_Amount_Due,0.0)-ISNULL(ticd.N_Discount_Amount,0.0)), @dtExecutionDate, ticd.S_Invoice_Number,tttm.S_Transaction_Code --susmita : 2022-10-10 : Consider Discount amount
