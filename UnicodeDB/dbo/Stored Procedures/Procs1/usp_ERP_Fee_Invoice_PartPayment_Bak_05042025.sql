...
-- exec [usp_ERP_Fee_Invoice_PartPayment] 107,'24-0353'                    
                    
CREATE PROCEDURE [dbo].[usp_ERP_Fee_Invoice_PartPayment_Bak_05042025](@iBrandID INT,@sStudentID NVARCHAR(MAX))                    
AS                    
BEGIN                    
                    
      --DECLARE @iBrandID INT=1                    
      --DECLARE @sStudentID VARCHAR(MAX)='24-0032'                    
...
nent_ID,        S_Component_Name ComponentName,N_Amount_Due,TotalTax,ISNULL(ReceiptCompAmount,0) as BaseAmountPaid,ISNULL(ReceiptCompTax,0) as TaxPaid,                    
