CREATE PROCEDURE [dbo].[usp_ERP_GET_Fee_Plan_Academic_Month_Structure_Migration]
...
print 1234
	...
	BEGIN
	   ...
	   TERC.S_Component_Name AS FeeComponentName,
		...
		CASE 
    WHEN TEFPT.I_Interval = 0 THEN 0
    ELSE TEFPT.I_Interval
END AS PayInterval,
	   ...
	   where TEFSIC.R_I_Fee_Structure_ID=@iFeeScheduleID and TEFSIC.Is_OneTime=0
