...
-- =============================================
CREATE   PROCEDURE [dbo].[usp_ERP_GetDayWiseSubjectPlanDetailsForSubject_BKP_DEC2023_BeforeFix] 
...
BEGIN
	...
	,CASE 
	WHEN SubjectTimePlan.Dt_Plan_Date IS NULL THEN 0
	ELSE 1
	...
	left join
	(
	select SSP.I_Subject_Structure_Plan_ID,TTP.Dt_Plan_Date from 
	T_ERP_Subject_Structure_Plan as SSP
	inner join
	T_ERP_Subject_Structure_Plan_Detail as SSPD on SSPD.I_Subject_Structure_Plan_ID=SSP.I_Subject_Structure_Plan_ID
	inner join
