--EXEC [usp_ERP_GetDebitCreditSettlement] '2025-04-30','2025-04-01',107,0

CREATE PROCEDURE [dbo].[usp_ERP_GetDebitCreditSettlement]  --[uspGetChequeSettlement] null,NULL,794,1     
    (
            ...
            BEGIN    
                ...
                WHERE  -- RH.I_PaymentMode_ID IN ( 13, 14, 15, 16, 17, 19, 20,21,22,23,24,25,28 )
                       -- AND RH.I_Centre_Id IN (
						...
						AND TPMM.IsAllowedForDebitCredit = 'true'
