CREATE Proc [dbo].[USP_ERP_NewStudentData_Fetch](          
@BrandID int          
)          
as           
begin          
...
St.I_Student_Detail_ID,          
    ...
    SBM.S_Batch_Name,          
       ...
       ST.S_Mobile_No          
    --,SUBSTRING(Cm.S_Course_Name, 1, CHARINDEX(' (2024)', Cm.S_Course_Name)) as ActualClassname          
    ,TC.S_Class_Name,          
    TS.S_Section_Name,          
    Strm.S_Stream,          
...
from T_Student_Batch_Details SBD          
 ...
 Left Join T_Student_Class_Section SCS on SCS.I_Student_Detail_ID=ST.I_Student_Detail_ID          
 ...
 Left Join T_Stream Strm on Strm.I_Stream_ID=SCS.I_Stream_ID and SCS.I_Status=1         
  Left Join          
    (          
        SELECT *,          
 ...
 Where CM.I_Brand_ID=@BrandID           
 and SBM.S_Batch_Name Like '%(2024)'           
 --and CM.S_Course_Name='Upper KG (2024)'          
       --and SBM.S_Batch_Name like '%DS%'          
    and SBD.I_Status = 1          
    and ST.I_Status=1          
    and SCS.I_Status=1          
    and CM.I_Status=1 and SBM.I_Status=2           
    --And TC.S_Class_Name in('Class XI','Class XII')          
    --and Strm.S_Stream is null          
   -- and TC.S_Class_Name<>SUBSTRING(Cm.S_Course_Name, 1, CHARINDEX(' (2024)', Cm.S_Course_Name) - 1)          
  --  and TS.S_Section_Name is null          
  -- and ST.I_Student_Detail_ID=127752          
  and Not Exists(          
