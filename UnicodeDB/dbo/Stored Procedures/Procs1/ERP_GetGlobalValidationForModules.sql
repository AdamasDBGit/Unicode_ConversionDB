--exec [ERP_GetGlobalValidationForModules] null,null,null,'Mu6B8SXdVcwwT2dgUnJk'
...
BEGIN      
set @BrandID = (select top 1 t2.I_Brand_ID from T_ERP_User t1 
inner join T_ERP_User_Brand t2 on t1.I_User_ID=t2.I_User_ID      
 where t1.S_Token=@Token and t2.Is_Teaching_Staff=1)      
 END      
