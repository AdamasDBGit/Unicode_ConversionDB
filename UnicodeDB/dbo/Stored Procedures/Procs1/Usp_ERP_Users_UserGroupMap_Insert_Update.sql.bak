...
--select * from #Userpermission as UP
--inner join
--T_ERP_role_Master as ERM on UP.Role_Id=ERM.I_Role_ID
--select * from #Userpermission


--select * from 
--T_ERP_Users_Role_Permission_Map  AS target
--where not exists (select * from #Userpermission source where 
...
--) 
--and target.Brand_ID=118 and target.I_User_Id=3196
