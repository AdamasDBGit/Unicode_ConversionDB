...
----Reason: For Uploading Fee Structure from backend
--Date:04.06.2024
-- =============================================            
            
CREATE PROCEDURE [dbo].[usp_ERP_insert_Update_Fee_Structure_Component_Bulkupload]            
   ...
   ,@out_I_Fee_Structure_ID int OUTPUT  
...
BEGIN            
  ...
  END        
   ...
   EXEC USP_ERP_OLD_Fee_Plan_Insert @NewFeeStructureID=@h_I_Fee_Structure_ID      
    select  @out_I_Fee_Structure_ID=@h_I_Fee_Structure_ID  
 IF @@ROWCOUNT  > 0      
