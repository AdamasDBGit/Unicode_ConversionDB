...
-- =============================================            
CREATE PROCEDURE [dbo].[usp_ERP_AddFeeComponent_bak_19022025]             
...
BEGIN            
 ...
 IF(@FeeHeadID>0)            
  ...
  EXEC Usp_ERP_DefaultGSTMAP_Comp @FeeHeadID,@BrandID,1   
  update T_Fee_Component_Master set Is_GST_Applicable=1    
  where I_Fee_Component_ID=@FeeHeadID    
 ...
 BEGIN            
  ...
  update T_Fee_Component_Master set Is_GST_Applicable=1  where I_Fee_Component_ID=@FeeCompID    
  End     
