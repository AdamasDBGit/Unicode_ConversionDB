...
-- =============================================
--EXEC usp_ERP_Exam_GetExamMarksList NULL,NULL,14
CREATE PROC [dbo].[usp_ERP_Exam_GetExamMarksList] 
(   
    @SessionId INT = NULL,
...
BEGIN 
    ...
    WITH PAGED AS (
        ...
        WHERE SD.inSaveType = 2 AND SSD.inAttendanceStatus = 3 '
  ...
  SD.inExamScheduleDetailId,
    ...
    EXEC sp_executesql @stSQL,
        N'@SessionId INT, @SchoolGroupId INT, @SchoolClassId INT, @ExamName NVARCHAR(200), @ExamScheduleStatus INT, @ExamTypeId INT, @ExamCategoryId INT',
