...
SET @childScheduleID=(  
select top 1 Child_I_Result_Exam_Schedule_ID from T_ERP_Result_Combine_Rule   
where Main_I_Result_Exam_Schedule_ID=@iExamScheduleID  
)  
--SET @StudentdetailID=  
--(  
...
--)  
 ...
 order by ISNULL(TS.S_Section_Name,'A')     
        ...
        If  (@iExamScheduleID  is NOt  NUll and   @childScheduleID is NOt Null)
   Begin   
...
SELECT    
 ...
 WHERE TRES.I_Result_Exam_Schedule_ID = ISNULL(@childScheduleID,TRES.I_Result_Exam_Schedule_ID)  
