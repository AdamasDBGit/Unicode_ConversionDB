CREATE PROCEDURE [dbo].[uspGetNewAttendanceDataAIT]
AS 
    BEGIN
        ...
        INSERT  INTO #temp
                EXEC REPORT.uspGetDueReport_History @sHierarchyList = '92', -- nvarchar(max)
                    @iBrandID = 108, -- int
        ...
        SELECT  TSD.S_Student_ID AS StudentID ,
                ...
                --YY.ID
                CASE WHEN TSD.I_Status=1  THEN 'YES'
