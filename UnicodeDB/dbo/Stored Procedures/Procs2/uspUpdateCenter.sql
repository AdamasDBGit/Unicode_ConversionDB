...
CREATE PROCEDURE [dbo].[uspUpdateCenter]
	@iCenterID int,	
	@sCenterCode NVARCHAR(MAX) = null,
	@sCenterName NVARCHAR(MAX),
	@sShortName NVARCHAR(MAX),
	@iCategory int,
	@iRFFType int,
	@iIsOwnCenter int,
	@sServiceTaxRegdNo NVARCHAR(MAX),
	...
	@sPhoneNumber NVARCHAR(MAX),
	@sEmail NVARCHAR(MAX),
	@sDelAddress1 NVARCHAR(MAX),
	@sDelAddress2 NVARCHAR(MAX),
	@iDelCityID int,
	@iDelStateID int,
	@iDelCountryID int,
	@sDelPinCode NVARCHAR(MAX),
	@sDelPhoneNumber NVARCHAR(MAX),
	@sDelEmail NVARCHAR(MAX),
