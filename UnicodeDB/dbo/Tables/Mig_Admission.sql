CREATE TABLE [dbo].[Mig_Admission] (
    [Branch]                                 NVARCHAR (255) NULL,
    [Source_From]                            NVARCHAR (255) NULL,
    [Enquiry_Type]                           NVARCHAR (255) NULL,
    [Enquiry_No(Unique No_System Generated)] FLOAT (53)     NULL,
    ...
    [Perm_City]                              FLOAT (53)     NULL,
    [Perm_State]                             FLOAT (53)     NULL,
    [Perm_Country]                           NVARCHAR (255) NULL,
    [S_Perm_Area]                            FLOAT (53)     NULL,
    ...
    [Student_ID(Unique System Generated )]   FLOAT (53)     NULL,
    [Stream]                                 NVARCHAR (255) NULL,
    [Section]                                NVARCHAR (255) NULL,
    [Roll No]                                FLOAT (53)     NULL,
    [Map_Fee Structure Name]                 NVARCHAR (255) NULL,
    [Registration Fee]                       FLOAT (53)     NULL,
    [1st  Payment Amount]                    NVARCHAR (255) NULL,
