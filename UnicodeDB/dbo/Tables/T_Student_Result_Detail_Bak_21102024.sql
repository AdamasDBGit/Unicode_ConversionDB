CREATE TABLE [dbo].[T_Student_Result_Detail_Bak_21102024] (
    ...
    [negative_marks]                 DECIMAL (10, 2) NULL,
    [get_correct]                    DECIMAL (10, 2) NULL,
    [not_attempted]                  DECIMAL (10, 2) NULL,
    [total_question]                 DECIMAL (10, 2) NULL,
    [get_incorrect]                  DECIMAL (10, 2) NULL
);
