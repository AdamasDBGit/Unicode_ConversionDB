CREATE TABLE [dbo].[T_Receipt_Header_Backdated_Deposit_Audit] (
    [I_Receipt_Header_Backdeated_Deposit_Audit_ID] INT             IDENTITY (1, 1) NOT NULL,
    ...
    [Dt_Current_Deposit_Date]                      DATETIME        NULL
);
