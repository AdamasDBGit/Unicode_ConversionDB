...
CREATE PROCEDURE [ECOMMERCE].[uspGetPlanList_BKP_NOV_22](@sBrandID VARCHAR(MAX), @ExamCategoryIDs VARCHAR(MAX)=NULL, @CategoryID INT=NULL, @CouponID INT=0, @ExamGroupIDs VARCHAR(MAX)=NULL, @ProductID INT=0)
AS
BEGIN
