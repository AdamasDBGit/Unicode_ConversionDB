...
CREATE PROCEDURE [ECOMMERCE].[uspGetCustomerPaidStatus_BKPBEFOREExtendedFeb2023] 
(
				...
				begin
						...
						from [ECOMMERCE].[T_Registration] TR 
								...
								left join (	Select TSM.I_Course_ID,TSBD.I_Student_ID from [dbo].[T_Student_Batch_Details] TSBD
											...
											) x  on x.I_Student_ID=TSD.I_Student_Detail_ID --susmita Paul 2022-12-12 : for getting all assigned or will be assigned batch courses
