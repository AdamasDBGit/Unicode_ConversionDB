CREATE PROCEDURE [REPORT].[uspGetTeacherReport_bySoma]
(
...
-----------
		INNER JOIN dbo.T_Term_Course_Map TTCM ON E.I_Course_ID = TTCM.I_Course_ID
...
C.I_Employee_ID=ISNULL(@iEmployeeID,C.I_Employee_ID)
 ...
 AND TTCM.I_Status=1 AND TTM.I_Status=1 AND TMTM.I_Status=1 AND TMM.I_Status=1
--AND
