...
CREATE PROCEDURE [ERP].[uspPrepareStudentCollectionReversalDataDebitCreditCrd_Arivoo]
(
...
BEGIN
	...
	AND trh.I_PaymentMode_ID IN (13,14,15,16,17,19,20,21,22,23,24,25,28,29,30,32)  --adding Ecom,Swipe debit,swipe credit payment mode  -- adding 32 arivoo payment mode for new Environment
