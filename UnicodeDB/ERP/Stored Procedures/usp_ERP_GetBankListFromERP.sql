...
CREATE PROCEDURE [ERP].[usp_ERP_GetBankListFromERP]
(
	@iBrandID INT
)
AS
...
INSERT INTO #temp
	...
	SELECT ERPBank.BANK_ACCOUNT_NAME,ERPBank.BANK_ACCOUNT_NUM,ERPBank.ENTITY_NAME FROM BANK_ACCOUNTS ERPBank
