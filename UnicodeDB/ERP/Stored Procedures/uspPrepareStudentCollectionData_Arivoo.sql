...
CREATE PROCEDURE [ERP].[uspPrepareStudentCollectionData_Arivoo]
(
...
BEGIN
	...
	AND trh.I_PaymentMode_ID IN (2,3,4,27,31)--Added by susmita : 2023-01-14 : 31 for Online Transfer Loan
